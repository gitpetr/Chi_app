...
# Articles
Article.create( title: "Почему возможна линеарная фактура?",
...
Article.create( title: "Целотоновый форшлаг: предпосылки и развитие",
...
Article.create( title: "Структурный гипнотический рифф: полиряд или лайн-ап?",
...
Article.create( title: "Модальный канал глазами современников",
...
Article.create( title: "Глубокий лайн-ап: предпосылки и развитие",
...
Article.create( title: "Хроматический полиряд: методология и особенности",
